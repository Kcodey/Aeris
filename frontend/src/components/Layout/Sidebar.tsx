          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 px-2.5 py-2 rounded-md text-xs font-medium transition-all duration-150 relative ${
                isActive
                  ? 'bg-white text-content-primary font-semibold shadow-sm -translate-y-px'
                  : 'text-content-secondary hover:bg-[#fff7ed]'
              }`}
            >
              <Icon size={16} />
              {item.label}
            ...
            <button
              ...
              className={`text-left px-2 py-1.5 rounded-md transition-all duration-150 truncate relative ${
                selectedConversationId === conv.id
                  ? 'bg-white text-content-primary font-medium shadow-sm -translate-y-px'
                  : 'text-content-tertiary hover:bg-[#fff7ed] hover:text-content-secondary'
              }`}
            >
